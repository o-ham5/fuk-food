...
from .situation_view import SituationRegister, SituationInfoGetView, SituationListGetView, SituationInfoUpdateView, SituationInfoDeleteView
from .kuchikomi_view import KuchikomiRegister, KuchikomiInfoGetView, KuchikomiListGetView, KuchikomiInfoUpdateView, KuchikomiInfoDeleteView, KuchikomiNeighborsListGetView, KuchikomiMedianListGetView
