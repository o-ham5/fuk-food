...
from ..views.kuchikomi_view import KuchikomiRegister, KuchikomiInfoGetView, KuchikomiListGetView, KuchikomiInfoUpdateView, KuchikomiInfoDeleteView, KuchikomiNeighborsListGetView, KuchikomiMedianListGetView
...
urlpatterns = [
    ...
    url(r'^median/$', KuchikomiMedianListGetView.as_view()),
